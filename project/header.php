	...
	<div class="container">
		<div class="row">
			<div class="col-md-3 text-dark col-12 col-sm-12 d-flex justify-content-center">
				<p class="m-0 py-2">welcome to mykart.com</p>
			</div>
...
<div class="container-fluid">
	<div class="container slider pt-4">
		...
		<div class="row px-2">
			<h1 class="display-4 text-light">Shopping Fastival</h1>
			<p class="text-light text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
	...
	<div class="row">
		<div class="col-md-3 p-4 col-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-9">
					<p class="p-0 m-0 font-weight-bold">Free Shipping</p>
		...
		<div class="col-md-3 p-4 col-6 col-sm-6">
			<div class="row">
				...
				<div class="col-md-9">
					<p class="p-0 m-0 font-weight-bold">Safe Payment</p>
					<small>on order over $99</small>
				</div>
			</div>
		</div>
